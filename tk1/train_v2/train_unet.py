...
# ===== LABELS =====
LABELS = {
    0: {"name": "brown_spot", "match_substrings": ["../data/new_data_field_rice_detected/unet_region_only/brown_spot"]},
    1: {"name": "leaf_blast", "match_substrings": ["../data/new_data_field_rice_detected/unet_region_only/leaf_blast"]},
    2: {"name": "leaf_blight", "match_substrings": ["../data/new_data_field_rice_detected/unet_region_only/leaf_blight"]},
    3: {"name": "healthy", "match_substrings": ["../data/new_data_field_rice_detected/unet_region_only/healthy"]}
}
