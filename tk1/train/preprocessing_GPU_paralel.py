...
class TunableConfig:
    ...
    def __init__(self):
        ...
        self.kmeans_min_cluster_frac = 0.02
        self.kmeans_ab_weight = 1.0
        ...
        self.lbp_min_area = 150
        
        # ========== 3. SUPERPIXEL REFINEMENT ==========
        self.use_superpixel_refine = True  # ✅ BẬT
        self.slic_region_size = 20
        self.slic_ruler = 10.0
        self.slic_min_size = 40
        self.superpixel_vote_ratio = 0.4
        
        # ========== 4. SHAPE FILTERS ==========
        self.shape_min_solidity = 0.6
        self.shape_max_eccentricity = 0.98
        ...
        self.viz_disease_alpha = 0.3
        self.viz_contour_color = (0, 255, 255)
